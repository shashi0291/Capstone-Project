...
INSERT INTO `category_list` VALUES (3,'Behavioral','Behavioral Patterns','These design patterns are specifically concerned with communication between objects.');
...
INSERT INTO `category_details` VALUES (2,'Structural','Bridge Pattern','Bridge Pattern Description','Bridge Pattern Implementation','icon_abstract_pattern');
INSERT INTO `category_details` VALUES (2,'Structural','Composite pattern','Composite pattern Description','Composite pattern Implementation','icon_abstract_pattern');
INSERT INTO `category_details` VALUES (3,'Behavioral','Observer Pattern','Observer Pattern Description','Observer Pattern Implementation','icon_abstract_pattern');
INSERT INTO `category_details` VALUES (3,'Behavioral','State pattern','State pattern Description','State pattern Implementation','icon_abstract_pattern');
COMMIT;
